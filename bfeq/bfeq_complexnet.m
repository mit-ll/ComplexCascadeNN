...
addpath ~/public/fingerPrinting/beamforming/gradient-descent/
homedir = '/afs/mitll/usr/sw17362/public';
addpath(genpath(fullfile(homedir,'MATLAB')));  % computexcorr, boldify
...
for ii=1:length(filenames)
    ...
    figure(1222); clf;
    subplot(211);
    plot([bers(:).sinrreim],'.-','MarkerSize',32); hold on;    
    plot([bers(:).sinrc],'.-','MarkerSize',32); 
