...
while true
    ...
    try
        ...
        wr2 = evalin('base','weightRecord2');
        je = evalin('base','jeRecord');
        jj = evalin('base','jjRecord');
    catch
        wr = {};
        wr2 = {};
        je = {};
    ...
    assignin('base','weightRecord2',wr2);
    assignin('base','jeRecord',je);
    assignin('base','jjRecord',jj);
